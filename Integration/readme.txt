...
OBS: if the error "buffer overflow detected" is present, then this might be caused by the path to the workcell is too long. Try moving the workcell or whole folder to a place with a shorter path (remember to edit absolute paths).
